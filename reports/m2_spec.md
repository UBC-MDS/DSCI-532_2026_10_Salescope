...
| --- | ------------------------------- | -------------- | ----------------------------- |
| 1   | When reviewing annual sales figures, I want to identify high-performing regions, so I can learn what replicate the best practices in these regions to those requiring intervention. | Implementation complete for M2 | Table element from the skeleton dashboard was used for the base of this user story.                              |
| 2   | When investigating abnormal changes in churn rate I want to determine the customers with a high risk of churn so I can infer optimal retention strategies for mitigating this risk. | Implementation complete for M2 | Scatter plot from the skeleton dashboard was used for the base of this user story. |
| 3   | When analyzing recent product sales, I want to visualize hidden patterns across product categories, seasons, and purchase times so I can optimize inventory planning for peak seasons and schedule targeted marketing campaigns during high-conversion periods. | Implementation complete for M2  | Heatmap from the skeleton dashboard was used for the base of this user story. A second similar heatmap for category frequencies was added as well. |
